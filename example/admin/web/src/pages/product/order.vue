...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_007'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/product/order/index', updateURL: '/product/order/update', updateKey: 'id'},
                search: [{label: '管理员', field: 'admin_name', type: 'text'}, {
                    label: '用户',
                    field: 'user_name',
                    type: 'text'
                }, {label: '产品', field: 'product_name', type: 'text'}, {
                    label: '订单编号',
                    field: 'order_sn',
                    type: 'text'
                }, {
                    ...
                    field: 'status',
                    type: 'selectNumber',
                    data: [{label: '结束', value: '-1'}, {label: '进行中', value: '10'}]
                }, {
                    label: '类型',
                    field: 'type',
                    type: 'selectNumber',
                    data: [{label: '授权订单', value: '1'}, {label: '质押订单', value: '2'}, {label: '合约订单', value: '10'}]
                },{label: '过期时间', field: 'expired_at', type: 'dateRangePicker'}, {
                    label: '收益时间',
                    field: 'updated_at',
                    type: 'dateRangePicker'
                }, {label: '创建时间', field: 'created_at', type: 'dateRangePicker'}],
                tools: [{
                    label: '新增',
                    ...
                    items: [{label: '用户名', field: 'username', type: 'text'}, {
                        ...
                        type: 'selectNumber',
                        data: [{label: '授权订单', value: '1'}, {label: '质押订单', value: '2'}, {label: '合约订单', value: '10'}]
                    },{label: '产品数量', field: 'nums', type: 'number'}]
                }, {
                    label: '删除',
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['admin_name', 'user_name', 'images', 'product_name', 'order_sn', 'money', 'nums', 'type', 'status', 'expired_at', 'updated_at', 'created_at', 'options'],
                columns: [{
                    label: '管理员',
                    field: 'admin_name',
                    name: 'admin_name',
                    ...
                    items: [{
                        ...
                        tips: '',
                        isShow: '',
                        items: [{label: '金额', field: 'money', type: 'number'}, {
                            label: '数量',
                            field: 'nums',
                            type: 'number'
                        }, {
