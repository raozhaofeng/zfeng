...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_002'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/logs/index', updateURL: '/logs/update', updateKey: 'id'},
                search: [{
                    label: '类型', field: 'type', type: 'selectNumber', data: [{label: '后端日志', value: 1}, {label: '前端日志', value: 2}]
                }, {label: '管理', field: 'admin_name', type: 'text'}, {
                    label: '用户',
                    field: 'username',
                    type: 'text'
                }, {
                    ...
                    field: 'name',
                    type: 'text'
                }, {label: '语言', field: 'lang', type: 'text'}, {
                    label: '设备',
                    field: 'user_agent',
                    type: 'text'
                }, {label: '数据', field: 'data', type: 'text'}, {label: 'IP', field: 'ip4', type: 'text'}, {
                    label: '路由',
                    field: 'route',
                    type: 'text'
                }, {
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['id', 'type', 'admin_name', 'username', 'name', 'ip4', 'user_agent', 'lang', 'route', 'data', 'created_at'],
                columns: [{
                    label: '主键',
                    field: 'id',
                    name: 'id',
                    ...
                    align: 'left',
                    sortable: true,
                    data: [{label: '后端日志', value: 1}, {label: '前端日志', value: 2}]
                }, {
                    label: '管理',
                    field: 'admin_name',
                    name: 'admin_name',
