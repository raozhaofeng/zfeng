...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_003'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/menu/index', updateURL: '/menu/update', updateKey: 'id'},
                search: [{label: '名称', field: 'name', type: 'text'}, {
                    label: '父级名称',
                    field: 'parent_name',
                    type: 'text'
                }, {
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['id', 'parent', 'name', 'parent_name', 'route', 'sort', 'status', 'data', 'options'],
                columns: [{
                    label: '主键',
                    field: 'id',
                    name: 'id',
                    ...
                    items: [{
                        ...
                        tips: '',
                        isShow: '',
                        items: [{label: '父级ID', field: 'parent', type: 'number'}, {
                            label: '名称',
                            field: 'name',
                            type: 'text'
                        }, {label: '路由', field: 'route', type: 'text'}, {
                            label: '排序',
                            field: 'sort',
                            type: 'number'
                        }, {
