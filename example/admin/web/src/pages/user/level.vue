...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_023'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/user/level/index', updateURL: '/user/level/update', updateKey: 'id'},
                ...
                tools: [{
                    ...
                    tips: '',
                    isShow: '',
                    items: [{label: '等级', field: 'level_id', type: 'selectNumber', data: []}, {
                        label: '用户',
                        field: 'username',
                        type: 'text'
                    }]
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['admin_name', 'username', 'level_name', 'data', 'status', 'created_at', 'updated_at', 'options'],
                columns: [{
                    label: '管理',
                    field: 'admin_name',
                    name: 'admin_name',
                    ...
                    items: [{
                        ...
                        items: [{label: '等级', field: 'level_id', type: 'selectNumber', data: []}, {
                            ...
                            field: 'created_at',
                            type: 'datePicker'
                        }, {label: '更新时间', field: 'updated_at', type: 'datePicker'}]
                    }, {
                        label: '删除',
                        url: '/user/level/delete',
                        color: 'negative',
        ...
        onMounted(() => {
            // 请求等级列表
            api.post('/level/levels', {}, {showLoading: false} as any).then((res: any) => {
                state.dynamicData['level_id'] = res
            })
