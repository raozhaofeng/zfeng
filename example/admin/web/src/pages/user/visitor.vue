...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_198698'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/visitor/index', updateURL: '/visitor/update', updateKey: 'id'},
                search: [{label: '管理', field: 'admin_name', type: 'text'}, {
                    label: '国家',
                    field: 'country_name',
                    type: 'text'
                }, {label: 'IP4', field: 'ip4', type: 'text'}, {
                    label: '时间',
                    field: 'updated_at',
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['admin_name', 'country_name', 'ip4', 'nums', 'updated_at'],
                columns: [{
                    label: '管理',
                    field: 'admin_name',
                    name: 'admin_name',
                    ...
                    align: 'left',
                    sortable: true
                }, {label: 'IP4', field: 'ip4', name: 'ip4', type: 'text', align: 'left', sortable: true}, {
                    label: '次数',
                    field: 'nums',
                    name: 'nums',
                    type: 'text',
                    align: 'left',
                    sortable: true
                }, {label: '时间', field: 'updated_at', name: 'updated_at', type: 'datePicker', align: 'left', sortable: true}]
            }
        })
