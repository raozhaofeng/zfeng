...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_016'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/wallet/account/index', updateURL: '/wallet/account/update', updateKey: 'id'},
                search: [{label: '管理', field: 'admin_name', type: 'text'}, {
                    label: '用户',
                    field: 'username',
                    type: 'text'
                }, {label: '提现方式', field: 'payment_name', type: 'text'}, {
                    label: '名称',
                    field: 'name',
                    type: 'text'
                }, {label: '姓名｜Token', field: 'real_name', type: 'text'}, {
                    label: '卡号｜地址',
                    field: 'card_number',
                    type: 'text'
                }, {label: '银行地址', field: 'address', type: 'text'}, {
                    label: '状态',
                    field: 'status',
                    type: 'selectNumber',
                ...
                tools: [{
                    ...
                    items: [{label: '用户名', field: 'username', type: 'text'}, {
                        ...
                        field: 'real_name',
                        type: 'text'
                    }, {label: '卡号｜地址', field: 'card_number', type: 'text'}, {
                        label: '银行地址',
                        field: 'address',
                        type: 'text'
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['admin_name', 'username', 'payment_name', 'name', 'real_name', 'card_number', 'address', 'status', 'sort', 'data', 'updated_at', 'options'],
                columns: [{
                    label: '管理',
                    field: 'admin_name',
                    name: 'admin_name',
                    ...
                    items: [{
                        label: '编辑',
                        url: '/wallet/account/update',
                        color: 'primary',
                        type: 'update',
                        tips: '',
                        isShow: '',
                        items: [{label: '名称', field: 'name', type: 'text'}, {
                            label: '姓名｜Token',
                            field: 'real_name',
                            type: 'text'
                        }, {label: '卡号｜地址', field: 'card_number', type: 'text'}, {
                            ...
                            type: 'selectNumber',
                            data: [{label: '激活', value: '10'}, {label: '禁用', value: '-1'}]
                        }, {label: '排序', field: 'sort', type: 'number'}, {
                            label: '数据',
                            field: 'data',
                            type: 'textarea'
                        }, {label: '创建时间', field: 'created_at', type: 'datePicker'}]
                    }, {
                        label: '删除',
                        url: '/wallet/account/delete',
                        color: 'negative',
        ...
        onMounted(() => {
            // 请求账单类型列表
            api.post('/payment/withdraw', {}, {showLoading: false} as any).then((res: any) => {
                state.dynamicData['payment_id'] = res
            })
