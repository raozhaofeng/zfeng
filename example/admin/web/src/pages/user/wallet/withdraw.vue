...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_018'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/wallet/withdraw/index', updateURL: '/wallet/withdraw/update', updateKey: 'id'},
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['order_sn', 'admin_name', 'username', 'payment_name', 'payment_real_name', 'payment_card_number', 'balance', 'money', 'money_fee', 'status', 'data', 'created_at', 'options'],
                columns: [{
                    label: '订单号',
                    field: 'order_sn',
                    name: 'order_sn',
