...
export default {
    ...
    setup() {
        ...
        const visibleStorage = '_table_visible_022'
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/user/invite/index', updateURL: '/user/invite/update', updateKey: 'id'},
                search: [{label: '管理', field: 'admin_name', type: 'text'}, {
                    label: '用户',
                    field: 'username',
                    type: 'text'
                }, {label: '邀请码', field: 'code', type: 'text'}, {
                    label: '状态',
                    field: 'status',
                    type: 'selectNumber',
                ...
                tools: [{
                    ...
                    items: [{
                        ...
                        field: 'type',
                        type: 'selectNumber',
                        data: [{label: '后台管理', value: '1'}, {label: '前台用户', value: '2'}]
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['admin_name', 'username', 'code', 'status', 'created_at', 'options'],
                columns: [{
                    label: '管理',
                    field: 'admin_name',
                    name: 'admin_name',
                    ...
                    items: [{
                        ...
                        tips: '',
                        isShow: '',
                        items: [{label: '邀请码', field: 'code', type: 'text'}, {
                            label: '状态',
                            field: 'status',
                            type: 'selectNumber',
                            data: [{label: '激活', value: '10'}, {label: '禁用', value: '-1'}]
                        }, {label: '时间', field: 'created_at', type: 'datePicker'}]
                    }]
                }]
            }
        })
