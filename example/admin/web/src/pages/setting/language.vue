...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_011'
        const dialogFormRef = ref(null) as any;
        const state = reactive({
            params: {
                pagination: {sortBy: 'status', descending: true, page: 0, rowsPerPage: 10}
            } as any,
            dialogForm: {} as any,
            rows: [] as any,
            dynamicData: {} as any,
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/lang/index', updateURL: '/lang/update', updateKey: 'id'},
                search: [{label: '管理', field: 'admin_name', type: 'text'}, {
                    label: '名称',
                    field: 'name',
                    type: 'text'
                }, {label: '别名', field: 'alias', type: 'text'}, {
                    label: '时间',
                    field: 'created_at',
                ...
                tools: [{
                    ...
                    tips: '',
                    isShow: '',
                    items: [{label: '图标', field: 'icon', type: 'image'}, {
                        label: '名称',
                        field: 'name',
                        type: 'text'
                    }, {label: '别名', field: 'alias', type: 'text'}]
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['id', 'icon', 'admin_name', 'name', 'alias', 'sort', 'status', 'data', 'created_at', 'options'],
                columns: [{
                    label: 'ID',
                    field: 'id',
                    name: 'id',
