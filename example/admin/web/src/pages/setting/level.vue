...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_012'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/level/index', updateURL: '/level/update', updateKey: 'id'},
                ...
                tools: [{
                    ...
                    tips: '',
                    isShow: '',
                    items: [{label: '名称(语言字典)', field: 'name', type: 'text'}, {
                        label: '图标',
                        field: 'icon',
                        type: 'image'
                    }, {label: '金额', field: 'money', type: 'number'}, {
                        label: '天数',
                        field: 'days',
                        type: 'number'
                    }, {label: '描述(语言字典)', field: 'data', type: 'textarea'}]
                }, {
                    label: '删除',
                    url: '/level/delete',
                    color: 'negative',
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['admin_name', 'name', 'icon', 'level', 'money', 'days', 'status', 'updated_at', 'options'],
                columns: [{
                    label: '管理员',
                    field: 'admin_name',
                    name: 'admin_name',
                    ...
                    items: [{
                        ...
                        items: [{label: '名称(语言字典)', field: 'name', type: 'text'}, {
                            ...
                            field: 'icon',
                            type: 'image'
                        }, {label: '等级', field: 'level', type: 'number'}, {
                            label: '金额',
                            field: 'money',
                            type: 'number'
                        }, {label: '天数', field: 'days', type: 'number'}, {
                            label: '描述(语言字典)',
                            field: 'data',
                            type: 'textarea'
                        }, {
