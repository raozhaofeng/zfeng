...
export default {
    ...
    setup() {
        const visibleStorage = '_table_visible_013'
        ...
        const state = reactive({
            ...
            checkboxList: [] as any,
            conf: {
                basic: {indexURL: '/payment/index', updateURL: '/payment/update', updateKey: 'id'},
                search: [{label: '管理', field: 'admin_name', type: 'text'}, {
                    label: '名称',
                    field: 'name',
                    type: 'text'
                }, {label: '名字｜Token', field: 'account_name', type: 'text'}, {
                    label: '卡号｜地址',
                    field: 'account_code',
                    type: 'text'
                }, {
                    ...
                    field: 'mode',
                    type: 'selectNumber',
                    data: [{label: '充值模式', value: '1'}, {label: '提现模式', value: '10'}]
                }, {
                    label: '类型',
                    field: 'type',
                    type: 'selectNumber',
                    data: [{label: '银行卡', value: '1'}, {label: '数字货币', value: '10'}, {label: '三方支付', value: '20'}]
                }, {
                    label: '状态',
                    field: 'status',
                    type: 'selectNumber',
                ...
                visibleColumns: localStorage.getItem(visibleStorage) ?
                    ...
                    ['admin_name', 'icon', 'mode', 'type', 'name', 'account_name', 'account_code', 'sort', 'status', 'description', 'updated_at', 'options'],
                columns: [{
                    label: '管理员',
                    field: 'admin_name',
                    name: 'admin_name',
                    ...
                    items: [{
                        ...
                        items: [{label: '名称', field: 'name', type: 'text'}, {
                            ...
                            field: 'type',
                            type: 'selectNumber',
                            data: [{label: '银行卡', value: '1'}, {label: '数字货币', value: '10'}, {
                                label: '三方支付',
                                value: '20'
                            }]
                        }, {
