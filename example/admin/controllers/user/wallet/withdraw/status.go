...
func Status(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	...
	if params.Status == models.WalletOrderStatusRefuse {
		err = models.UserFundingChanges(tx, userInfo.AdminId, userInfo.Id, userInfo.ParentId, nil, 0, models.UserBillTypeWithdrawRefuse, userInfo.Money, walletOrderInfo.Money)
		if err != nil {
			body.ErrorJSON(w, err.Error(), -1)
			return
		}
